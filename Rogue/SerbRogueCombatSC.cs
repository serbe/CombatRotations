...
namespace ReBot
{
	...
	public class SerbRogueCombatSC : SerbRogue
	{
		...
		public override void Combat ()
		{
			...
			if (Time > 10 && (ComboPoints < 3 || (HasSpell ("Anticipation") && SpellCharges ("Anticipation") < 3) || (ComboPoints < 4 || (HasSpell ("Anticipation") && SpellCharges ("Anticipation") < 4))) && ((HasSpell ("Shadow Focus") && !HasSpell ("Adrenaline Rush") && Energy < 90 && Energy >= 15) || (HasSpell ("Subterfuge") && Energy >= 90) || (!HasSpell ("Shadow Focus") && !HasSpell ("Subterfuge") && Energy >= 60)))
			if (Vanish ())
				return;
			...
			if (ComboPoints < 5 || !Target.HasAura ("Revealing Strike", true) || (HasSpell ("Anticipation") && SpellCharges ("Anticipation") < 3 && !HasAura ("Deep Insight")))
			if (ActionGenerators ())
				return;
