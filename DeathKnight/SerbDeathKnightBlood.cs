...
namespace ReBot
{
	...
	public class SerbDeathKnightBloodSC : DeathKnight
	{
		...
		public bool Bos ()
		{
			...
			if (RunicPower > 85 && (Me.AuraTimeRemaining ("Convulsive Shadows") > 5 || Me.AuraTimeRemaining ("Convulsive Shadows") > 2 && Me.HasAura ("Bloodlust"))) {
				if (DeathCoil ())
					return true;
			}
			...
			if (RunicPower < 16 && RunicPower > 5 && !Me.HasAura ("Crimson Scourge") && (Blood >= 1 && Death == 0 || Blood == 2 && Death < 2)) {
				if (BloodBoil ())
					return true;
			}
			...
			if (RunicPower < 16 && !Me.HasAura ("Crimson Scourge") && (Blood >= 1 && Death == 0 || Blood == 2 && Death < 2)) {
				if (BloodBoil ())
					return true;
			}
		...
		public bool Cdbos ()
		{
			...
			if ((Target.AuraTimeRemaining ("Frost Fever", true) < 4 && Target.HasAura ("Frost Fever", true)) || (Target.AuraTimeRemaining ("Blood Plague", true) < 4 && Target.HasAura ("Blood Plague", true))) {
				if (BloodBoil ())
					return true;
			}
